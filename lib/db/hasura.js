...
export const getMyListVideos = async (user_id, token) => {

  const operationsDoc = `
  query myFavouriteVideos($user_id: String) {
    netflix_stats(where: {user_id: {_eq: $user_id}, favourited: {_eq: 1}}) {
      video_id
    }
  }
`;
